...
function getHoliday(year) {
    ...
    khmer_holidays = [
        ...
        {
            date: `${year}-01-07`,
            description: "ទិវា​ជ័យ​ជម្នះ​លើ​របប​ប្រល័យ​ពូជ​សាសន៍",
            English: "Victory Day"
        },
        {
            date: `${year}-03-08`,
            description: "ទិវាសិទ្ធនារី ៨មីនា",
...

        {
            ...
            English: "International Labor Day"
        },
        {
            date: `${year}-05-14`,
            description: "ព្រះ​រាជ​ពិធី​បុណ្យ​ចម្រើន​ព្រះ​ជន្ម ព្រះបាទនរោត្តមសីហមុនី",
            English: "King Sihamoni's Birthday"
        },
        {
            date: `${year}-06-18`,
            description: "ព្រះ​រាជ​ពិធី​បុណ្យ​ចម្រើន​ព្រះ​ជន្ម សម្តេច​ព្រះ​មហាក្សត្រីនរោត្តម មុនិនាថ សីហនុ",
            English: "Queen Mother's Birthday"
        },
        {
            date: `${year}-09-24`,
            description: "ទិវារដ្ឋធម្មនុញ្ញ",
            English: "Constitution Day"
        },

        {
            date: `${year}-10-15`,
            description: "រំលឹកវិញ្ញាណក្ខន្ធ សម្តេចឪ ",
            English: "Commemoration of Late King Father"
        },
        {
            date: `${year}-10-29`,
            description: "ព្រះរាជពិធីឡើងគ្រងរាជ្យរបស់ព្រះបាទនរោត្តមសីហមុនី",
            English: "King Norodom Sihamoni’s Coronation Day"
        },

        {
            date: `${year}-11-09`,
            description: "ទិវាឯករាជ្យជាតិ",
            English: "Independence Day"
        },

        {
            date: `${year}-12-29`,
            description: "ទិវាសន្តិភាព",
            English: "Peace Day"
        },
    ]
}
